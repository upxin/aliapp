<template>
  ...
  >
    <div class="font-bold text-20px mt-130px text-fff pb-30px w-full">
      修改密码
    </div>
    <div class="flex flex-col items-center mb-30px">
      ...
      />
      <NrzInput
        v-model:value="formData.confirmPsw"
        class="mb-20px w-full"
        style="border-bottom: 1px solid #f5f5f5"
        placeholder="确认密码"
        :inp-class="{ 'text-primary': true, 'bg-transparent': true }"
...
import { ref } from 'vue';
import { getObuInfo, memberLogin, getCode, reetPsw } from '@/api/index';
