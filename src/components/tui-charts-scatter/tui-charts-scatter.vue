<template>
  <view class="tui-charts__scatter-wrap" :style="{ width: width + 'rpx' }">
    <view class="tui-scatter__legend" v-if="legend.show">
      <view
        class="tui-scatter__legend-item"
    ...
    >
      ...
      >
        ...
        <view
          ...
          :style="{
            color: xAxisLabel.color,
            fontSize: xAxisLabel.size + 'rpx',
          }"
        >
          {{ item.value }}
        </view>
      ...
      >
        ...
        ></view>
        <view
          class="tui-yAxis__val"
          :style="{
            color: yAxisLabel.color,
            fontSize: yAxisLabel.size + 'rpx',
          }"
        >
          {{ item.value }}
        </view>
      ...
      <view v-for="(item, index) in dataset" :key="item.id">
        <view
          @tap.stop="onDotTap(index, idx, model)"
    ...
    <view
      class="tui-scatter__tooltip"
      v-if="tooltip"
      :class="{ 'tui-scatter__tooltip-show': tooltipShow }"
    >
      <view class="tui-tooltip__title"></view>
      <view class="tui-scatter__tooltip-item">
        <view
          class="tui-legend__circle"
          :style="{ background: tooltips.color }"
        ></view>
