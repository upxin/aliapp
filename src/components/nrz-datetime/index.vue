<template>
  <view class="tui-datetime-picker" :style="{ zIndex }">
    ...
    >
      ...
      >
        <view v-if="type < 4 || type == 7 || type == 8" class="tui-date-unit"
          >年</view
        >
        <view v-if="type < 4 || type == 7 || type == 8" class="tui-date-unit"
          >月</view
        ...
        <view
          ...
          >时</view
        >
        <view v-if="(type == 1 || type > 3) && type != 8" class="tui-date-unit"
          >分</view
        >
        <view v-if="type > 4 && type != 8" class="tui-date-unit">秒</view>
      </view>
      <view
      ...
      >
        ...
        >
          <picker-view-column v-if="type < 4 || type == 7 || type == 8">
            ...
            >
              {{ item }}
              <text v-if="!unitTop" class="tui-date__unit-text">年</text>
            </view>
          </picker-view-column>
          <picker-view-column v-if="type < 4 || type == 7 || type == 8">
            <view
            ...
            >
              {{ formatNum(item) }}
              <text v-if="!unitTop" class="tui-date__unit-text">月</text>
            </view>
          </picker-view-column>
          <picker-view-column
            v-if="type == 1 || type == 2 || type == 7 || type == 8"
          >
            ...
            >
              {{ formatNum(item) }}
              <text v-if="!unitTop" class="tui-date__unit-text">日</text>
            </view>
          </picker-view-column>
          <picker-view-column
            v-if="type == 1 || type == 4 || type == 5 || type == 7 || type == 8"
          >
            ...
            >
              {{ formatNum(item) }}
              <text v-if="!unitTop" class="tui-date__unit-text">时</text>
            </view>
          </picker-view-column>
          <picker-view-column v-if="(type == 1 || type > 3) && type != 8">
            ...
            >
              {{ formatNum(item) }}
              <text v-if="!unitTop" class="tui-date__unit-text">分</text>
            </view>
          </picker-view-column>
          <picker-view-column v-if="type > 4 && type != 8">
            ...
            >
              {{ formatNum(item) }}
              <text v-if="!unitTop" class="tui-date__unit-text">秒</text>
            </view>
          </picker-view-column>
        </picker-view>
      </view>
...
export default {
  ...
  methods: {
    ...
    setMonths() {
      this.months = this.generateArray(1, this.maxMonth);
    },
    setDays() {
      if (this.type == 3 || this.type == 4) return;
      let totalDays = new Date(this.year, this.month, 0).getDate();
      totalDays = !totalDays || totalDays < 1 ? 1 : totalDays;
      this.days = this.generateArray(1, this.maxDay ? this.maxDay : totalDays);
    },
    setHours() {
    ...
    selectResult() {
      ...
      this.$emit('update:modelValue', result.result);
    },
    waitFix() {
      if (this.isEnd) {
        this.selectResult();
